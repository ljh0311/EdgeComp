...
from .models.unified_wav2vec2 import UnifiedWav2Vec2Detector
from .models.unified_basic import UnifiedBasicDetector
...
class ModelBenchmark:
    ...
    def __init__(self, config: dict):
        ...
        self.models = {
            ...
            "wav2vec2": UnifiedWav2Vec2Detector(config),
            "basic": UnifiedBasicDetector(config.get("model_path")),
        }
    ...
    def measure_inference_time(
        self, model: BaseSoundDetector, audio_data: np.ndarray, num_runs: int = 10
    ) -> Dict[str, float]:
    ...
    def measure_memory_usage(self, model: BaseSoundDetector) -> Dict[str, float]:
        ...
        return {"baseline": baseline, "peak": peak, "used": peak - baseline}
    ...
    def benchmark_model(
        self, model_name: str, audio_data: np.ndarray
    ) -> Dict[str, Any]:
...
def main():
    ...
    # Load config
    config = {"model_path": "models/hubert/", "confidence_threshold": 0.5}
