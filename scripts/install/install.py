...
def run_gui_installer():
    ...
    try:
        from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                                  ...
                                  QGroupBox, QHBoxLayout, QMessageBox, QProgressBar)
        ...
        def run(self):
            ...
            try:
                ...
                if process.returncode == 0:
                    ...
                    self.update_signal.emit(f"Installation failed with code {process.returncode}")
    ...
    class InstallerWindow(QMainWindow):
        ...
        def __init__(self):
            ...
            logo_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 
                                  "src", "babymonitor", "web", "static", "img", "logo.png")
            ...
            # Subtitle
            subtitle_label = QLabel("A comprehensive baby monitoring solution with AI features")
            ...
            self.install_type_combo.addItems(["Full Installation", "Minimal Installation"])
...
"""
        ...
        def start_installation(self):
            ...
            try:
                ...
                QMessageBox.critical(self, "Python Version Error", 
                                  "Unsupported Python version. Please use Python 3.8 - 3.11.")
                return
            
            # Check dependencies
            if not check_dependencies():
                result = QMessageBox.warning(self, "Missing Dependencies", 
