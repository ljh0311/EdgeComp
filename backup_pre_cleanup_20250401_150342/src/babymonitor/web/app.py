...
class BabyMonitorWeb:
    ...
    def setup_routes(self):
        ...
        def status():
            ...
            return jsonify(
                {
                    "camera_enabled": self.video_capture is not None
        ...
        def get_system_info():
            ...
            try:
                ...
                model_info = getattr(
                    ...
                    "model_info",
                    {"name": "Unknown", "type": "Unknown", "emotions": []},
                )
                ...
                info = {
                    ...
                    "system_info": {
                        ...
                        "camera_resolution": (
                            f"{int(self.video_capture.get(cv2.CAP_PROP_FRAME_WIDTH))}x{int(self.video_capture.get(cv2.CAP_PROP_FRAME_HEIGHT))}"
                        ...
                        "audio_sample_rate": getattr(
                            self.emotion_detector, "SAMPLE_RATE", "Not available"
                        ),
                    },
